...
<form action="plussave.php" id="setForm_<?php echo $divid; ?>" method="post" enctype="multipart/form-data" name="form" style="margin:0px">
<div class="scrollex">
<div class="adminnav">
...
?>
<?php echo $strPlusSetup." &gt; ".$pagename." &gt; ".$set_plusname; ?></div>
...
<select name="borderstyle" id="borderstyle" >
              ...
              <td width="60" ><input id="backgroundcolor" class="selcolor" name="backgroundcolor"  style="background:<?php echo $backgroundcolor; ?>" type="text" value="<?php echo $backgroundcolor; ?>" size="7"  maxlength="7" /></td>
            </tr>
            <tr >
              <td width="70"><?php echo $strPlusBar; ?></td>
              <td width="70" >
<select name="showbar" id="showbar" >
...
<select name="borderroll" id="borderroll" >
	...
	<div class="setupplustemp">
		...
		<li id="ptsel_P" class="ptempcoloropt" style="background:#92c300"></li>
			...
			<input type="hidden" id="tempname" name="tempname" size="30"  value="<?php echo $tempname; ?>" class="input" />
			<input type="hidden" id="set_tempname" name="stn" value="<?php echo $set_tempname; ?>" />
            <input type="hidden" id="tempcolor" name="tempcolor" size="30" value="<?php echo $tempcolor; ?>" class="input" />
	...
	<div id="s_setcanshu"  class="pluszonex">
			 ...
			 <table width="600" border="0" cellspacing="0" cellpadding="5">	
			   <tr >
                 ...
                 <td >				
				 <input type="text" id="coltitle" name="title" size="30"  maxlength="30" value="<?php echo $title; ?>" class="input" />
				 </td>
		       </tr>
...
<select name="padding" id="padding" >
			 ...
			 <tr >
			   <td width="90"><?php echo $strPlusFlow; ?></td>
			   <td >
...
?>
			  <option value="RAND()" <?php echo seld( $ord, "RAND()" ); ?>>rand</option>
              </select>
			  </td>
		  </tr>
...
<select name="sc" >
            ...
            <tr  <?php echo plustrdis( $set_shownums ); ?>> 
              ...
              <td > 
                ...
                <input  type="text" name="shownums" size="3"  maxlength="3" value="<?php echo $shownums; ?>">
              </td>
            </tr>
...
<select name="fittype" >
            ...
            <tr  <?php echo plustrdis( $set_cutword ); ?>> 
              ...
              <td >                 
                <input type="text" name="cutword" size="3"  maxlength="3" value="<?php echo $cutword; ?>"> 
              </td>
            </tr>
			 <tr  <?php echo plustrdis( $set_cutbody ); ?>> 
              ...
              <td > 
                ...
                <input type="text" name="cutbody" size="3"  maxlength="3" value="<?php echo $cutbody; ?>"> 
              </td>
            </tr>
			...
			<tr  <?php echo plustrdis( $set_tags ); ?>> 
              ...
              <td > 
                ...
                <input type="text" name="tags" size="10"  maxlength="20" value="<?php echo $tags; ?>"> 
              </td>
            </tr>
...
<select name="target"  style='WIDTH:247px;'>
			...
			<tr  <?php echo plustrdis( $set_pic ); ?>> 
              ...
              <td >
			   ...
			   <input name="pic" type="hidden" id="pic" value="<?php echo $pic; ?>">
			    <?php 
			    	list($p1,$p2,$p3) = explode("/",$pic);
			    ?>
			   <a href="../../editpro/ref.php?mode=../<?php echo $p1."/".$p2."/"; ?>&indir=<?php echo $p3; ?>" target="_blank" style="line-height:32px;color:#3c6da8;font-weight:bold;"><?php echo $strPlusUpDel; ?></a>
              </td>
            </tr>
			...
			<tr  <?php echo plustrdis( $set_piclink ); ?>> 
              ...
              <td>
			   <input name="piclink" type="text" class="input" id="piclink" style='WIDTH: 320px;' value="<?php echo $piclink; ?>" >
              </td>
            </tr>
...
<input type="submit" id="submit_<?php echo $divid; ?>" name="submit"  class="button"  value="<?php echo $strConfirm; ?>"  onClick="KindSubmit();" />
...
<table  border="0" cellspacing="1" cellpadding="1">
             <tr >
			   ...
			   <td <?php echo plustrmuldis( $set_setglobal, $set_ifmul, $set_pluslocat ); ?>>
			   <input name="setglobal" type="checkbox" id="setglobal" value="1" /> 
			  </td>
			 
			 
			   <td <?php echo plustrmuldis( $set_setglobal, $set_ifmul, $set_pluslocat ); ?>>
			    <?php echo $strPlusGlobal1; ?>
			  </td>
