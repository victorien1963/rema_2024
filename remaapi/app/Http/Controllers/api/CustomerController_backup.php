...
class CustomerController extends Controller
{
    public function sendMail($data = null)
    {
        ...
        if($data['status'] != "0"){
            // $emails = array("ppcs0520@yahoo.com.tw","eric@rema-sports.com","richie@rema-sports.com","Celia@rema-sports.com","nini2525@gmail.com");
...
/*        if(isset($_GET['mix'])){
 ...
 /*                   $data["styleCode"] = $bn; //NINI
                 ...
                 //   $data = $this->posturl($url,$data);
                    ...
                    print_r(json_encode($data));
                    print_r('<br>');
             /*NINI       $data=json_decode($data, true);
                    print_R($data);
                    print_R('<br><br><br>');
                    if($data['errorCode'] == 0){
                        if(!$data['datas'] == null){
