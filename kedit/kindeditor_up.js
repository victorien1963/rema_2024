...
K.options = {
	...
	fontSizeTable : ['9px', '10px', '12px', '13px', '14px', '15px', '16px', '18px', '24px', '32px'],
	htmlTags : {
...
_extend(KWidget, {
	...
	autoPos : function(width, height) {
		var self = this,
			...
			gg = window.parent.document.documentElement.scrollTop || window.parent.pageYOffset || window.parent.document.body.scrollTop;
			//slob ADD gg 2016-08-15
		if (self._alignEl) {
