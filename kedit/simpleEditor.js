...
var KE_LANG = {
	INPUT_URL		: "請輸入正確的URL地址。",
	SELECT_IMAGE	: "請選擇圖片。",
	INVALID_IMAGE	: "只能選擇GIF,JPG,PNG,BMP格式的圖片，請重新選擇。",
	INVALID_FLASH	: "只能選擇SWF格式的文件，請重新選擇。",
	INVALID_MEDIA	: "只能選擇MP3,WAV,WMA,WMV,MID,AVI,MPG,ASF格式的檔案，請重新選擇。",
	INVALID_REAL	: "只能選擇RM,RMVB格式的檔案，請重新選擇。",
	INVALID_WIDTH	: "寬度不是數字，請重新輸入。",
	INVALID_HEIGHT	: "高度不是數字，請重新輸入。",
	INVALID_BORDER	: "邊框不是數字，請重新輸入。",
	INVALID_HSPACE	: "橫隔不是數字，請重新輸入。",
	INVALID_VSPACE	: "豎隔不是數字，請重新輸入。",
	INPUT_CONTENT	: "請輸入內容",
	TITLE			: "描述",
	WIDTH			: "寬",
	HEIGHT			: "高",
...
var KE_FONT_NAME = Array(
	...
	Array('PMingLiU', '新細明體'), 	
	Array('DFKai-sb', '標楷體'), 
	Array('Microsoft JhengHei', '微軟正黑體'), 
	Array('Arial', 'Arial'), 
...
var KE_TOP_TOOLBAR_ICON = Array(
	Array('KE_SOURCE', 'source.gif', '視圖轉換'),
	Array('KE_PREVIEW', 'preview.gif', '預覽'),
	//Array('KE_ZOOM', 'zoom.gif', '顯示比例'),
	//Array('KE_PRINT', 'print.gif', '列印'),
	Array('KE_UNDO', 'undo.gif', '復原'),
	Array('KE_REDO', 'redo.gif', '重做'),
	Array('KE_CUT', 'cut.gif', '剪下'),
	Array('KE_COPY', 'copy.gif', '複製'),
	Array('KE_PASTE', 'paste.gif', '貼上'),
	Array('KE_SELECTALL', 'selectall.gif', '全選'),
	Array('KE_JUSTIFYLEFT', 'justifyleft.gif', '靠左對齊'),
	Array('KE_JUSTIFYCENTER', 'justifycenter.gif', '置中'),
	Array('KE_JUSTIFYRIGHT', 'justifyright.gif', '靠右對齊'),
	Array('KE_JUSTIFYFULL', 'justifyfull.gif', '左右對齊'),
	Array('KE_NUMBEREDLIST', 'numberedlist.gif', '編號'),
	Array('KE_UNORDERLIST', 'unorderedlist.gif', '項目符號'),
	Array('KE_INDENT', 'indent.gif', '減少縮排'),
	Array('KE_OUTDENT', 'outdent.gif', '增加縮排'),
	Array('KE_SUBSCRIPT', 'subscript.gif', '下標'),
	Array('KE_SUPERSCRIPT', 'superscript.gif', '上標'),
	Array('KE_SPECIALCHAR', 'specialchar.gif', '特殊字元'),
	Array('KE_DATE', 'date.gif', '日期'),
	Array('KE_TIME', 'time.gif', '時間')
);
var KE_BOTTOM_TOOLBAR_ICON = Array(
	Array('KE_TITLE', 'title.gif', '標題'),
	Array('KE_FONTNAME', 'font.gif', '字體'),
	Array('KE_FONTSIZE', 'fontsize.gif', '文字大小'),
	Array('KE_TEXTCOLOR', 'textcolor.gif', '文字顏色'),
	Array('KE_BGCOLOR', 'bgcolor.gif', '文字背景'),
	Array('KE_BOLD', 'bold.gif', '粗體'),
	Array('KE_ITALIC', 'italic.gif', '斜體'),
	Array('KE_UNDERLINE', 'underline.gif', '底線'),
	Array('KE_STRIKE', 'strikethrough.gif', '刪除線'),
	Array('KE_REMOVE', 'removeformat.gif', '刪除格式'),
	Array('KE_IMAGE', 'image.gif', '圖片'),
	Array('KE_FLASH', 'flash.gif', 'Flash'),
	Array('KE_MEDIA', 'media.gif', 'Windows Media Player'),
	Array('KE_REAL', 'real.gif', 'Real Player'),
	Array('KE_LAYER', 'layer.gif', '圖層'),
	Array('KE_TABLE', 'table.gif', '表格'),
	Array('KE_HR', 'hr.gif', '橫線'),
	Array('KE_ICON', 'emoticons.gif', '笑臉'),
	Array('KE_LINK', 'link.gif', '創建超連結'),
	Array('KE_UNLINK', 'unlink.gif', '刪除超連結')
	//Array('KE_ABOUT', 'about.gif', '關於')
);
var KE_SIMPLE_TOOLBAR_ICON = Array(
	...
	Array('KE_BOLD', 'bold.gif', '粗體'),
	Array('KE_ITALIC', 'italic.gif', '斜體'),
	Array('KE_UNDERLINE', 'underline.gif', '下劃線'),
	Array('KE_JUSTIFYLEFT', 'justifyleft.gif', '左對齊'),
	Array('KE_JUSTIFYCENTER', 'justifycenter.gif', '居中'),
	Array('KE_JUSTIFYRIGHT', 'justifyright.gif', '右對齊'),
	Array('KE_IMAGE', 'image.gif', '圖片'),
	Array('KE_FLASH', 'flash.gif', 'Flash'),
	Array('KE_LAYER', 'layer.gif', '圖層'),
	Array('KE_HR', 'hr.gif', '橫線'),
...
function KindPopupMenu(cmd)
{
	switch (cmd)
	{
		...
		case 'KE_ICON':
			...
			str += '<tr><td colspan="6" bgcolor="#FFFFFF"><div id="icon_name_1" style="padding:2px;border:0;cursor:pointer;float:left;background:#EEEEEE;" onclick="KindGetIcon(1);">預設</div><div id="icon_name_2" style="padding:2px;border:0;cursor:pointer;float:left;" onclick="KindGetIcon(2);">QQ</div><div id="icon_name_3" style="padding:2px;border:0;cursor:pointer;float:left;" onclick="KindGetIcon(3);">洋蔥頭</div><div id="icon_name_4" style="padding:2px;border:0;cursor:pointer;float:left;" onclick="KindGetIcon(4);">米魯蛋</div></td></tr>';
			...
			str += '</table><table id="icon_pic_3" style="display:none">';
			for (i = 0; i < 138; i++) {
				if (i == 0 || (i >= 12 && i%12 == 0)) {
					str += '<tr>';
				}
				...
				var iconUrl = KE_ICON_PATH + 'onion/onion_' + num + '.gif';
				str += '<td style="padding:2px;border:0;cursor:pointer;" ' + 
				'onclick="javascript:KindExecute(\'KE_ICON_END\', \'' + iconUrl + '\');">' +
				'<img src="' + iconUrl + '" style="border:1px solid #EEEEEE;width:24px;height:24px;" onmouseover="javascript:this.style.borderColor=\'#AAAAAA\';" ' +
				'onmouseout="javascript:this.style.borderColor=\'#EEEEEE\';">' + '</td>';
			...
			str += '</table><table id="icon_pic_4" style="display:none">';
			for (i = 0; i < 108; i++) {
				if (i == 0 || (i >= 12 && i%12 == 0)) {
					str += '<tr>';
				}
				...
				if ((i+1).toString(10).length < 2) {
					num = '00' + (i+1);
				} else if((i+1).toString(10).length < 3){
					num = '0' + (i+1);
				} else {
					num = (i+1).toString(10);
				}
				var iconUrl = KE_ICON_PATH + 'eggs/egg_' + num + '.jpg';
				str += '<td style="padding:2px;border:0;cursor:pointer;" ' + 
				'onclick="javascript:KindExecute(\'KE_ICON_END\', \'' + iconUrl + '\');">' +
				'<img src="' + iconUrl + '" style="border:1px solid #EEEEEE;width:24px;height:24px;" onmouseover="javascript:this.style.borderColor=\'#AAAAAA\';" ' +
				'onmouseout="javascript:this.style.borderColor=\'#EEEEEE\';">' + '</td>';
