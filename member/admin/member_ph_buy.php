  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
    <tr>
      ...
      <td  class="biaoti"><span class="title"><?php echo $strMemberFrom23; ?></span></td>
       <td  class="biaoti" width="100"><span class="title"><?php echo $strMemberBuyTotal; ?></span></td>
...
for ( $i = 0;	$i < sizeof( $arr );	$i++	)
{
  ...
  <td width=\"60\">".$ph."</td> 
        ...
        <td width=\"55\"><a href=\"buylist.php?memberid=".$memberid."\"><img src=\"images/look.png\"  border=\"0\" /></a></td>
</tr>";
		}
}
?>
