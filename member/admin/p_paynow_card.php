...
<span class="title">商家交易碼</span></td>
      ...
      <tr>
		...
		(請確認網址正確，否則將導致交易失敗)
		  <input name="postfile" type="hidden" id="postfile" value="paynow_card_post.php" />
          <input name="recfile" type="hidden" id="recfile" value="paynow_card_rec.php" />
    	  <input name="key2" type="hidden" id="key2" value="paynow_card_ord.php" />
	    </td>
      </tr>
</table>