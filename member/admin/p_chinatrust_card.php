...
<tr >
        <td width="100" align="right" class="title">特店代號</td>
        <td width="5" align="right" class="title">&nbsp;</td>
        <td><input name="pcenteruser" type="text"  class="input" id="pcenteruser" value="<?php echo $pcenteruser; ?>" size="35" /> (MerchantID)
        </td>
      </tr>
      <tr >
        <td width="100" align="right">
<span class="title">終端機代號</span></td>
...
<tr>
		...
		(請確認網址正確，否則將導致判別是否付款失敗)
		  <input name="postfile" type="hidden" id="postfile" value="chinatrust_card_post.php" />
          <input name="recfile" type="hidden" id="recfile" value="chinatrust_card_rec.php" />
	    </td>
      </tr>
</table>