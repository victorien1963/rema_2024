...
<tr class=\"list\"> 
        <td width=\"80\"  > ".$addtime." </td>
        <td width=\"65\">".$type."</td>
        <td width=\"75\">".$method."</td>
        <td   height=\"26\">".$oof."</td>
        <td width=\"80\"><input name=\"memo\" type=\"text\" class=\"input\" id=\"memo\" value=\"".$memo."\" size=\"20\" />
          <input type=\"hidden\" name=\"memberid\" value=\"".$memberid."\" />
          <input type=\"hidden\" name=\"step\" value=\"modify\" />
          <input type=\"hidden\" name=\"id\" value=\"".$id."\" />          </td>
        <td width=\"80\"><input type=\"text\" name=\"fpnum\" class=\"input\" size=\"15\" value=\"".$fpnum."\" /></td>
