...
$hiddenString .= "<input type='hidden' name='PayType' Value='01'>";//付款方式 01：信用卡02：WebATM03：虛擬帳號
...
$hiddenString .= "<input type='image' class='bigbutton' src='{#RP#}base/files/Brusco/ShoppingCart/Finish/Cread1_Next_131x30.png' value='通過".$pcenter."付款'>";
$hiddenString .= "</form>";
