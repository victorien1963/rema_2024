...
$hiddenString .= "<input type='hidden' name='PayType' Value='03'>";//付款方式 01：信用卡02：WebATM03：虛擬帳號
...
$hiddenString .= "<input type='hidden' name='AtmRespost' Value='1'>";//需回傳虛擬帳號? 交易時帶入新參數.表賣家須接虛擬 帳號新回傳參數(不帶入視為不接收)
