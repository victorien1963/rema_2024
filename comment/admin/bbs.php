...
if(nn!='<?php echo $ord; ?>'){
	window.location='bbs.php?page=<?php echo $page; ?>&sc=<?php echo $sc; ?>&showpid=<?php echo $showpid; ?>&showtj=<?php echo $showtj; ?>&showfb=<?php echo $showfb; ?>&shownum=<?php echo $shownum; ?>&ord='+nn;
}else{
	if(sc=='asc' || sc==''){
	window.location='bbs.php?page=<?php echo $page; ?>&sc=desc&showpid=<?php echo $showpid; ?>&showtj=<?php echo $showtj; ?>&showfb=<?php echo $showfb; ?>&shownum=<?php echo $shownum; ?>&ord='+nn;
	}else{
	window.location='bbs.php?page=<?php echo $page; ?>&sc=asc&showpid=<?php echo $showpid; ?>&showtj=<?php echo $showtj; ?>&showfb=<?php echo $showfb; ?>&shownum=<?php echo $shownum; ?>&ord='+nn;
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr class=list> 
    ...
    <td width="50"  class="biaoti"  style="cursor:pointer" onClick="ordsc('id','<?php echo $sc; ?>')"><?php echo $strBianhao; ordsc( $ord, "id", $sc );?>
</td>
    <td height="28" width="60"  class="biaoti"  ><?php echo $strCommentType; ?></td>
    <td height="28" class="biaoti" style="cursor:pointer" onClick="ordsc('title','<?php echo $sc; ?>')"><?php echo $strTitle; ordsc( $ord, "title", $sc ); ?>
</td>
    <td height="28" width="139"  class="biaoti"  style="cursor:pointer" onClick="ordsc('uptime','<?php echo $sc; ?>')"><?php echo $strUptime; ordsc( $ord, "uptime", $sc ); ?></td>
    <td height="28" width="50"  class="biaoti"  style="cursor:pointer" onClick="ordsc('cl','<?php echo $sc; ?>')"><?php echo $strClick; ordsc( $ord, "cl", $sc ); ?></td>
    <td height="28" width="50"  class="biaoti"  ><?php echo $strCommentType2; ?></td>
    <td height="28" width="39"  class="biaoti"><?php echo $strFabu; ?></td>
    <td height="28" width="39"  class="biaoti"><?php echo $strTuiJian; ?></td>
    <td height="28" width="39"  class="biaoti"><?php echo $strLook; ?></td>
  </tr>  
...
while ( $msql->next_record( ) )
{
    ...
    <tr class=list> 
      ...
      <td width=\"50\" height=\"26\"> ".$id." </td>
      <td width=\"60\">".$type."</td>
      <td>".$title."      </td>
      <td width=\"139\">".$uptime."</td>
      <td width=\"50\">".$cl."</td>
      ...
      <td width=\"39\"> ";
		...
		echo " </td>
      <td width=\"39\"> 
        <img src=\"images/look.png\" style=\"cursor:pointer\" onClick=\"window.open('".$look."','_blank')\"> 
      </td>
    </tr>
    ";
}
...
<input type="checkbox" name="SELALL" value="1" onClick="SelAll(this.form)" /><?php echo $strSelAll; ?>&nbsp; 
        ...
        <input type="radio" name="step" value="fball" checked /><?php echo $strFb; ?>
         <input type="radio" name="step" value="notfball" /><?php echo $strNotFb; ?>
         <input type="radio" name="step" value="tjall" /><?php echo $strTj; ?>
         <input type="radio" name="step" value="nottjall" /><?php echo $strNotTj; ?> &nbsp;&nbsp;<a style="cursor:pointer;font-weight:bold" onClick="delfm.submit()">[ <?php echo $strSubmit; ?> ]</a> 
...
<div id="showpages">
	  <div id="pagesinfo">
<?php echo $strPagesTotalStart.$totalnums.$strPagesTotalEnd; ?> 
<?php echo $strPagesMeiye.$pagesinfo['shownum'].$strPagesTotalEnd; ?> 
<?php echo $strPagesYeci; ?> 
<?php echo $pagesinfo['now']."/".$pagesinfo['total']; ?>
</div>
