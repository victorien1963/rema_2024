...
<table width="100%" border="0" cellspacing="0" cellpadding="6" align="center">
  <tr>
    ...
    <td  class="innerbiaoti" width="50" align="center"><?php echo $strCatTemp; ?></td>
    <td  class="innerbiaoti" width="36" align="center"><?php echo $strLook; ?></td>
...
?> 
  <tr class="list">
    ...
    <td width="50"  ><input type="checkbox" id="setcattemp_<?php echo $catid;?>" name="setcattemp" value="<?php echo cat;?>" <?php echo checked( $ifcattemp, "1" );?> class="setcattemp"></td>
    <td  width="36"><a href="../class/?<?php echo $catid;?>.html" target="_blank"><img src="images/look.png"  border="0" /></a></td>
