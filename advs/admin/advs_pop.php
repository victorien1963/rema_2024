...
<textarea id="body" name="body" style="width:680px;height:400px;visibility:hidden;"><?php echo $body; ?></textarea>
	...
	<script>
		KindEditor.ready(function(K) {
			var editor = K.create('textarea[name="body"]', {
				uploadJson : '../../kedit/php/upload_json.php?attachPath=advs/pics/',
				fileManagerJson : '../../kedit/php/file_manager_json.php?attachPath=advs/pics/',
