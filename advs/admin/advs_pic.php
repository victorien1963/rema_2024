...
if($step=="del"){
	...
	$msql->query("select src from {P}_advs_pic_translate where pid='$id'");
	...
	$msql->query("delete from {P}_advs_pic_translate where pid='$id'");
		...
		<div class="portlet">
			...
			<div id="f-2" class="panel-collapse collapse in">
				...
				<div class="portlet-body">
					...
					<button type="button" class="btn btn-success" onClick="window.location='advs_pic_modi.php?id=0'">

						<i class="fa fa-pencil-square"></i> <?php echo $strAdvsAdd; ?>
					...
					<table class="table table-bordered table-striped table-hover tc-table table-primary footable" data-page-size="50">
						...
						<thead>
							...
							<tr>
								...
								<th class="col-large center" data-sort-ignore="true"><?php echo $strAdvsName; ?></th>

								<th class="col-medium center" data-hide="phone,tablet" data-sort-ignore="true"><?php echo $strAdvsPic; ?></th>

								<th class="col-small center" data-hide="phone,tablet" data-sort-ignore="true"><?php echo $strAdvsTarget; ?></th>
...
<?php 
	...
	while ($msql -> next_record ()) {
		...
		$targetstr = $target=="_self"? $strSelf:$strBlank;
...
?>
  ...
  <tr> 
    ...
    <td class="col-small center"><?php echo $targetstr; ?></td>

    <td><?php echo $url; ?></td>    

    <td class="col-mini center"> <img src="images/edit.png"  style="cursor:pointer" onClick="window.location='advs_pic_modi.php?id=<?php echo $id; ?>'"></td>

    <td class="col-mini center"> <img src="images/delete.png"  style="cursor:pointer" onClick="window.location='advs_pic.php?step=del&id=<?php echo $id; ?>'"></td>
