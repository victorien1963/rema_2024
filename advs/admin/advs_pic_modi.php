		...
		foreach($lans AS $ks=>$vs){
...

			{
				...
				$msql->getupdate(
					...
					"SELECT id FROM {P}_advs_pic_translate WHERE pid='{$id}' AND langcode='{$vs}'",

					"UPDATE {P}_advs_pic_translate SET 
					...
					"INSERT INTO {P}_advs_pic_translate SET 
...
<form name="advs_pic_modi.php" class="form-horizontal" action="" method="post" enctype="multipart/form-data">

	<div class="form-group">

		<label class="col-sm-1 control-label"><font color="#FF3300">* </font><?php echo $strAdvsName; ?></label>
	...
	<div class="form-group">
		...
		<label class="col-sm-1 control-label"><?php echo $strAdvsTarget; ?></label>
	...
	<div class="form-group">
		...
		<label class="col-sm-1 control-label"><?php echo $strAdvsMemo; ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="col-sm-12 input-group">
...

				{
					...
					echo "<img id='preview_".$id."' src='images/noimage.gif' >";
...

				{
					...
					echo "<a class=' input-group' href=\"\" onclick=\"callcolorbox('".ROOTPATH.$src."'); return false;\" ><img id='preview_".$id."' src='images/image.gif' ></a>";
	...
	<div class="form-actions">
		...
		<div class="form-group">
			...
			<div class="col-sm-offset-1 col-sm-10">
		        ...
		        <input type="button" name="Submit2" value="<?php echo $strBack; ?>" class="btn btn-default" onClick="self.location='advs_pic.php'" />
...
<?php
...

	{
		...
		$langs = $fsql->getone( "SELECT * FROM {P}_advs_pic_translate WHERE pid='{$id}' AND langcode='{$langcode}'" );
					...
					<div id="no-<?php echo $lid; ?>" class="panel-collapse collapse in">
						...
						<div class="portlet-body">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label"><?php echo $strAdvsName; ?></label>
...
<!-- END MAIN PAGE CONTENT -->
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('#pagetitle', window.parent.document).html('廣告管理 <span class="sub-title" id="subtitle"><?php echo $strSetMenu1; ?></span>');
