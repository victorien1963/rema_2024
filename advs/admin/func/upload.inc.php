...
function NewUploadImage($jpg,$jpg_type,$jpg_size,$path){
	...
	if (($jpg_type != "image/pjpeg" && $jpg_type != "image/jpeg" && $jpg_type!= "image/gif" && $jpg_type != "image/x-png" && $jpg_type != "image/png" && $jpg_type != "application/x-shockwave-flash") && $jpg_type != "video/mp4" ) {
...
function NewUploadImage1($jpg,$jpg_type,$jpg_size,$path){
	...
	if ($jpg_type != "image/pjpeg" && $jpg_type != "image/jpeg" && $jpg_type!= "image/gif" && $jpg_type != "image/x-png" && $jpg_type != "image/png" && $jpg_type != "application/x-shockwave-flash") {
