...
function ImageResize($from_filename, $save_filename, $in_width=1200, $in_height=1200, $quality=100)
{
...
function NewUploadImage( $jpg, $jpg_type, $jpg_size, $path, $in_width=1200, $in_height=1200, $sin_width=450, $sin_height=450 )

{
				...
				{
								$arr[0] = "err";
								$arr[1] = $strUploadNotice3.$jpg_type;
								return $arr;
				}
				switch ( $jpg_type )
				{
				...
				if($UploadImage[2] == "swf"){
					...
					if(check_animation($jpg)){
						...
						copy( $jpg, $file_path );
						chmod ($file_path,0666);
						$nGif = new GIF_eXG($file_path,1);
						$nGif->resize($sp_file_path,$sin_width,$sin_height,1,1);
						//copy( $jpg, $sp_file_path );				
						chmod ($sp_file_path,0666);
					}else{
						ImageResize($jpg,$file_path,$in_width,$in_height,'100');
						chmod ($file_path,0666);
						ImageResize($jpg,$sp_file_path,$sin_width,$sin_height,'100');
						chmod ($sp_file_path,0666);
					}
				}
				$UploadImage[0] = "OK";
