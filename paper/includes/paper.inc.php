...
function PaperConfig(){
	...
	$msql->query("select * from {P}_paper_config");
	while($msql->next_record()){
	
	$variable=$msql->f('variable');
	$value=$msql->f('value');
	$GLOBALS["PAPERCONF"][$variable]=$value;
	}
...
function PaperToUrl(){
	...
	$tourl="";
	$fsql->query("select * from {P}_paper_con where id='$id' limit 0,1");
	if($fsql->next_record()){
		$tourl=$fsql->f('tourl');
	}
...
function PaperUploadImage($jpg,$jpg_type,$jpg_size,$path){
	...
	if ($jpg_size > $GLOBALS['PAPERCONF']["PicSizeLimit"]) {
			$arr[0]="err";
...
function NewUploadFile($jpg,$jpg_type,$fname,$jpg_size,$path){
	...
	if ($jpg_size > $GLOBALS['PAPERCONF']["FileSizeLimit"]) {
			$arr[0]="err";
...
function pstarnums($n,$RP){
	...
	if($n<0.5){
		$str='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
	...
	if($n>=0.5 && $n<1.0){
		$str='<img src='.$RP.'paper/templates/images/icon_star_3.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
	...
	if($n>=1.0 && $n<1.5){
		$str='<img src='.$RP.'paper/templates/images/icon_star_2.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
		$str.='<img src='.$RP.'paper/templates/images/icon_star_1.gif>';
