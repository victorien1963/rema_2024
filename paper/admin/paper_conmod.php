...
$id = $_REQUEST['id'];
$pid = $_REQUEST['pid'];
$msql->query( "select * from {P}_paper_con where  id='{$id}'" );
if ( $msql->next_record( ) )
{
		$id = $msql->f( "id" );
		$catid = $msql->f( "catid" );
...
<div class="tc-tabs">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#tab1" class="tab" data-toggle="tab"><i class="fa fa-pencil bigger-130"></i> <?php echo $strPaperModify; ?></a></li>
		<!--li><a href="#tab2" class="tab" data-toggle="tab"><i class="fa fa-exchange bigger-130"></i> 多國翻譯</a></li-->
	</ul>
			
<form id="paperForm" name="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
<div  id="notice" class="noticediv"></div>
	...
	<div class="form-group papermodizone">
		...
		<div class="col-sm-6">
			...
			if ( $catid == "0" )
			{
					//echo "<option value='0' selected>".$strPaperBlog."</option>";
			}
	...
	<div id="proplist" class="papermodizone"></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			...
			<script>
				KindEditor.ready(function(K) {
					var editor = K.create('textarea[name="body"]', {
						...
						fileManagerJson : '../../kedit/php/file_manager_json.php?attachPath=paper/upload/',
			...
			<input type="hidden" id="act" name="act" value="papermodify" />
	...
	<div class="form-group">
		...
		<div class="col-sm-6 btn-toolbar" id="paperpages">
	...
	<div class="form-group papermodizone">
		...
		<div class="col-sm-2">
			<input type="text" name="author" id="author" placeholder="<?php echo $strPaperAddAuthor; ?>" value="<?php echo $author; ?>" class="form-control" maxlength="200">
		</div>
	</div>
	<!--div class="form-group papermodizone">
		<label class="col-sm-1 control-label"><?php echo $strPaperAddSource; ?></label>
		<div class="col-sm-6">
			<input type="text" name="source" id="source" placeholder="<?php echo $strPaperAddSource; ?>" value="<?php echo $source; ?>" class="form-control">
		</div>
	</div-->
	<div class="form-group papermodizone">
	...
	<div class="form-actions papermodizone">
		<div class="form-group">
...
<?php
	...
	while ( $msql->next_record( ) )
	{
		...
		//依表擷取語言檔內容
		$langs = $fsql->getone( "SELECT * FROM {P}_paper_con_translate WHERE pid='{$id}' AND langcode='{$langcode}'" );
?>
<!-- 依表列出語言檔內容 -->
				<div class="portlet no-border">
					...
					<div id="no-<?php echo $lid; ?>" class="panel-collapse collapse in form-horizontal">
						<div class="portlet-body">
							...
							<div class="form-group papermodizone">
								<label class="col-sm-1 control-label"><?php echo $strPaperAddTitle; ?></label>
								<div class="col-sm-6">
							...
							<div id="proplist_<?php echo $langcode; ?>" class="papermodizone"></div>
							...
							<div class="form-group papermodizone">
								...
								<div class="col-sm-6">
									<div class="col-sm-12 input-group">
										...
										if ( $langs['src'] == "" )
										{
											echo "<img id='preview_".$id."' class='preview123 input-group' src='images/noimage.gif' >";
										}
										else
										{
...
<!-- END MAIN PAGE CONTENT -->
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('#pagetitle', window.parent.document).html('電子報管理 <span class="sub-title" id="subtitle">電子報編輯</span>');
			//呼叫左側功能選單
			$().getMenuGroup('paper');
		});
	</script>
