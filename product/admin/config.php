...
<div class="tablezone">
	...
	$msql->query("select * from {P}_product_config  order by xuhao");
...
?> 
                ...
                <?php echo $strNo; ?> <?php
}elseif($settype=="ownersys"){

?>
                <select name="var[<?php echo $variable; ?>]" >
                  <option value="0" <?php echo seld($value,0); ?> ><?php echo $strEmailSys0; ?></option>
				  <option value="1" <?php echo seld($value,1); ?> ><?php echo $strEmailSys1; ?></option>
                  <option value="2" <?php echo seld($value,2); ?>><?php echo $strEmailSys2; ?></option>
                </select>
                <?php
