...
$(document).ready(function() {
	...
	$("li#m1").click(function() {
			$("iframe#framecon")[0].src='product_con.php';
	});
	$("li#m2").click(function() {
			$("iframe#framecon")[0].src='product_conadd.php';
	});
	$("li#m3").click(function() {
			$("iframe#framecon")[0].src='product_cat.php';
	});
	$("li#m4").click(function() {
			$("iframe#framecon")[0].src='product_proj.php';
	});
