...
var cookieexp=<?php echo $cookieexp;?>*1000; //cookie過期時間(毫秒)
...
var foldernamelen=75,filenamelen=55;  //在小圖標下的目錄名和檔案名的長度
var namelength=15; //在大圖標下
var preload=<?echo ($preload)?"true":"false";?>;  //預下載
...
var big_icon = [];
<?php
foreach($big_icons as $types=>$img)
{
	$type = explode('|',$types);
	foreach($type as $t)
	{
