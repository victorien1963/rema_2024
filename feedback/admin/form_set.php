...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
  <tr> 
     ...
     <td align="right" >
     	 ...
     	 <input type="checkbox" name="sendmail" value="1" <?php echo $ismail;?> > <?php echo $strSendMail;?>
	</td> 
  </tr>
</table>
</div>
...
$used=$_POST["used"];
$xuhao=$_POST["xuhao"];
$ismail = $_POST["sendmail"]?$_POST["sendmail"]:"0";
	...
	$msql->query("update {P}_feedback_group set ifano = '$ismail' where id = '$groupid'");
...
?> 
        <input type="hidden" name="field_id[<?php echo $i; ?>]" value="<?php echo "$id[$i]"; ?>">
        <input type="hidden" name="moveable[<?php echo $i; ?>]" value="<?php echo "$field_moveable[$i]"; ?>">
      </td>
